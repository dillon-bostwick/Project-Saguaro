...
return ["&lt?xml version=&quot1.0&quot encoding=&quotUTF-8&quot&gt&lt?qbxml version=&quot4.0&quot?&gt&ltQBXML&gt&ltQBXMLMsgsRq onError = &quotstopOnError&quot&gt&ltBillAddRq requestID = &quot2&gt&ltBillAdd&gt&ltVendorRef&gt&ltFullName&gtDaigle Lighting&lt/FullName&gt&lt/VendorRef&gt&ltAPAccountRef&gt&ltFullName&gtAccounts Payable&lt/FullName&gt&lt/APAccountRef&gt&ltTxnDate&gt2004-10-28&lt/TxnDate&gt&ltDueDate&gt2004-11-28&lt/DueDate&gt&ltTermsRef&gt&ltFullName&gtNet 30&lt/FullName&gt&lt/TermsRef&gt&ltLinkToTxnID&gt25D6-1071508328&lt/LinkToTxnID&gt&ltLinkToTxnID&gt53C4-1197730858&lt/LinkToTxnID&gt&lt/BillAdd&gt&lt/BillAddRq&gt&lt/QBXMLMsgsRq&gt&lt/QBXML&gt"];

    //serviceLog("This is the XML that is sent:\n");
    //serviceLog(requestXML);
 ...
 * version number: `&ltMajor&gt.&ltMinor&gt.&ltRelease&gt.&ltBuild&gt`
 * @example
 * // returns 2.0
 * parseForVersion("2.0.1.30");
 * @param input {String} A version number
 * @returns {String} First two version components (i.e. &lt;Major&gt.&lt;Minor&gt)
 ...
 *  - "W:&ltany text&gt" if you want the web Connector to display
 ...
 *  - "E:&ltany text&gt" if you want to cancel the update and
 ...
 *    with the update.
 *  - "O:&ltversion number&gt" to tell the user that the server
...
function (args) {
    ...
    if (strVersion &lt recommendedVersion) {
        retVal = 'W:We recommend that you upgrade your QBWebConnector';
    } else if (strVersion &lt supportedMinVersion) {
...
module.exports.run = function runQBWS(server) {
    ...
    serviceLog("Soap server running on process environ or 5000");
