...
function buildRequest() {
    ...
    inputXML = builder.create('QBXML', { version: '1.0'})
                     ...
                     .ele('QBXLMMsgsRq', { 'onError': 'stopOnError' })
                        .ele('IBillAdd', { 'requestID': '1' })
                            .ele('VendorRef')
                                .ele('FullName')
                                    .text('This is a vendor name')
                            .ele('memo')
                                .text('No expenses but has vendor');

    request.push(inputXML.end());

    inputXML = builder.create('QBXML', { version: '1.0'})
                     .instruction('qbxml', 'version="13.0"')
                     .ele('QBXLMMsgsRq', { 'onError': 'stopOnError' })
                        .ele('IBillAdd', { 'requestID': '2' })
                            .ele('memo')
                                .text('1 expense')
                            .ele('ExpenseLineAddList')
                                .ele('AccountRef')
                                    .ele('FullName')
                                        .text('name of a vendor')
                     ...
                     .ele('QBXLMMsgsRq', { 'onError': 'stopOnError' })
                        .ele('IBillAdd', { 'requestID': '3' })
                            ...
                            .ele('ExpenseLineAddList')
                                .ele('AccountRef')
                                    .ele('FullName')
                                        .text('name of first vendor')
                            .ele('ExpenseLineAddList')
                                .ele('AccountRef')
                                    .ele('FullName')
                                        .text('name of second vendor')
